    ...
    try:
        ...
        if ticker:
            ...
            if df is None or df.empty:
                ...
                if getattr(df, "attrs", {}).get("placeholder"):
                    st.warning("Mostrando datos simulados temporalmente mientras no se puede conectar a Yahoo Finance.")
                ...
                if comp_df is not None and not comp_df.empty:
                    if getattr(comp_df, "attrs", {}).get("placeholder"):
                        st.warning("Mostrando comparación con datos simulados por falta de conexión al servicio de mercado.")
    ...
    try:
        ...
        if sel:
            ...
            if prices is None or prices.empty:
                ...
                if getattr(prices, "attrs", {}).get("placeholder"):
                    st.warning("Usando trayectorias simuladas mientras se restablece la conexión con Yahoo Finance.")
        ...
        if ticker:
            ...
            if res["returns"] is None:
                ...
                if res.get("placeholder"):
                    st.warning("Análisis basado en datos simulados debido a problemas de descarga.")
                r_df = res["returns"]
    ...
    try:
        ...
        if sel:
            ...
            if sim["prices"] is None:
                ...
                if sim.get("placeholder"):
                    st.warning("Simulación generada con datos sintéticos mientras no hay conexión a precios reales.")
